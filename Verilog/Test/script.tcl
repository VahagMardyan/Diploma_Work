...
set out_file        "dataset_power_test.csv"
set error_log       "synthesis_errors_test.log"
set checkpoint_file "completed_combos_test.log"
...
# Frequency list (MHz)
set freq_list { 10 25 50 100 200 400 800 1000 }

# SWITCHING ACTIVITY CONFIGURATION
set toggle_values { 0.05 0.25 0.50 0.75 0.95 }
set static_values { 0.05 0.25 0.50 0.75 0.95 }

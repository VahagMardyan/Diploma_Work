...
wire              c1, c2, c3                          ;//carry wires for RCA stages
...
//FIX: merged what used to be two separate always blocks (both driving
//xtemp/ytemp) into one, and added begin/end around the reset branch so
//both registers are correctly cleared together on reset.
always @ (posedge clk)
   begin
      if (reset)
         begin

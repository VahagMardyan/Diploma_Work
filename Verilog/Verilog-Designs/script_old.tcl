...
set out_file  "dataset_power_new.csv"
set error_log "synthesis_errors.log"

# set freq_list {10 50 100 200 500}
...
foreach f $all_v_files {
    ...
    foreach corner $pvt_corners {
        ...
        # Frequency and switching activity sweeps
